...
def desenha_tela(janela, estado, altura_tela, largura_tela):
    ...
    inicio_primeiro_caracter_x = (largura_tela//2)-60 #Define centro da tela no eixo x
    inicio_primeiro_caracter_y = (altura_tela//2)-20  #Define centro da tela no eixo y
    
    #Coloca frase da tela de instruções na tela
    for caracter in estado['frase_tela_game_over']:
